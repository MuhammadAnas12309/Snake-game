...
// //Get High scroe from local storage

// let highScore = localStorage.getItem("high-scroe") || 0;
// highScoreElement.innerText = `High Scroe: ${highScore}`; 

// // pass a rendom button 1  and 30 as food position
...
// // change Direction on each hey click
...
//         snakeBody.push([foodY, foodX]); //Add food to snake body array
//         score++;
//         highScore = score >= highScore ? score : highScore; //if scroe => high scroe = scroe
...
//     // Shifting forwards values of elements in snake body by one
...
//     // check snakebody is out of wall or no
...
//     for(let i = 0; i < snakeBody.length; i++){
//         html += `<div class="head" style="grid-area; ${snakeBody[i][1]} / ${snakeBody
//             [i][0]}"></div>`;
//             // check snake head hit body or no
//             if(i !== 0 && snakeBody[0][1] === snakeBody[i][1] && snakeBody[0][0] === snakeBody[i][0]){
//                 gameOver = true;
